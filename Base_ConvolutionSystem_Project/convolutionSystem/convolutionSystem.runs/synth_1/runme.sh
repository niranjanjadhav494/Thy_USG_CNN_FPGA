...
HD_PWD='/home/niranjan/XilinxToolsProjects/convolutionSystem/convolutionSystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convolutionSystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convolutionSystem_wrapper.tcl
